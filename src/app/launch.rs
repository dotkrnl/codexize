...
impl App {
    ...
    pub(super) fn launch_final_validation(&mut self) {
        let _ = self.launch_final_validation_with_model(None);
    }

    pub(super) fn launch_final_validation_with_model(
        &mut self,
        override_model: Option<CachedModel>,
    ) -> bool {
        self.clear_agent_error();
    ...
    pub(super) fn launch_simplifier(&mut self) {
        let _ = self.launch_simplifier_with_model(None);
    }

    pub(super) fn launch_simplifier_with_model(
        &mut self,
        override_model: Option<CachedModel>,
    ) -> bool {
        self.clear_agent_error();
