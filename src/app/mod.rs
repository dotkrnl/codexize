...
fn write_review_scope_artifact(round_dir: &std::path::Path, base_sha: &str) -> std::io::Result<()> {
...
mod tests {
    ...
    fn coder_round_state(session_id: &str) -> SessionState {
    ...
    fn build_progress_follow_app(state: SessionState, current_run_id: u64) -> App {
        let mut app = mk_app(state);
