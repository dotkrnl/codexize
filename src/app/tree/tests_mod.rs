...
fn builder_recovery_sits_between_blocked_round_and_new_round_inside_task() {
    let mut state = SessionState::new("test".to_string());
    state.current_stage = Stage::Implementation(5);
...
fn recovery_rounds_include_sharding_run_sharing_recovery_round_without_pipeline_mode() {
    let mut state = SessionState::new("test".to_string());
    state.current_stage = Stage::Implementation(6);
...
fn final_validation_gap_tasks_render_under_new_iteration_trio() {
    ...
    use crate::state::PipelineItem;
    let mut state = SessionState::new("test".to_string());
    state.current_stage = Stage::Implementation(2);
...
fn test_agent_run_node_tough_suffix() {
    ...
    normal_run.effort = crate::data::adapters::EffortLevel::Normal;
    ...
    tough_codex.effort = crate::data::adapters::EffortLevel::Tough;
    ...
    tough_claude.effort = crate::data::adapters::EffortLevel::Tough;
    ...
    tough_gemini.effort = crate::data::adapters::EffortLevel::Tough;
    ...
    low_codex.effort = crate::data::adapters::EffortLevel::Low;
...
fn test_task_node_tough_badge() {
    ...
    tough_run.effort = crate::data::adapters::EffortLevel::Tough;
