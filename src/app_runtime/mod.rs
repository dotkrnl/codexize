...
//! the TUI frontend. Terminal polling lives in the
//! TUI leaf, with focus-local command handling still owned by
//! [`crate::app::App`]. The module also reifies the runtime/UI seam as two
...
pub use run::{RuntimePublisher, build_connector, run_frontend};
