...
fn stage_for_retry(stage_id: StageId) -> Stage {
    match stage_id {
        ...
        StageId::Implementation => Stage::Implementation(1),
        StageId::Recovery => Stage::Implementation(1),
        StageId::RecoveryPlanReview => Stage::Implementation(1),
        StageId::RecoverySharding => Stage::Implementation(1),
        StageId::Review => Stage::Review(1),
        StageId::Simplification => Stage::Review(1),
