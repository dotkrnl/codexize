...
impl Default for PathsSection {
    fn default() -> Self {
        Self {
            cache_root: Override::baked("$HOME/.codexize/cache".to_string()),
            sessions_root: Override::baked("$HOME/.codexize/sessions".to_string()),
            runs_root: Override::baked("$HOME/.codexize/runs".to_string()),
            memory_root: Override::baked("$HOME/.codexize/memory".to_string()),
        }
    }
}
